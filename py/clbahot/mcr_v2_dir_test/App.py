...
# 기능 모듈 임포트
from mcr_v2_dir_test.ui.MainFrame import MainFrame
from mcr_v2_dir_test.features.PredefinedLows import 생성_선정된_로우들
from mcr_v2_dir_test.features.AreaSelection import 영역_선택
from mcr_v2_dir_test.features.MPMonitoring import 시작_MP모니터링
